...
public interface KeySightVci_Electricity extends Library {
    String dllName = "D:\\NTC\\visa32";
    /**
     * 默认的成功
     */
    int STATUS_FAIL = 1;
    ...
    KeySightVci_Electricity KEYSIGHTINSTANCE = Native.loadLibrary(dllName, KeySightVci_Electricity.class);
